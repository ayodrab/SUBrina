...
export const EventsSection: React.FC<EventsSectionProps> = ({ events, onOpenDonate }) => {
  return (
    <section id="events" className="py-20 sm:py-28 px-4 sm:px-6 md:px-10 bg-[#25123d] text-[#fdf4ff] border-t-2 border-[#2e1065]">
      <div className="max-w-7xl mx-auto">
        {/* Section Heading */}
        <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_0.6fr] gap-8 items-end mb-16">
          <div>
            <div className="section-kicker">04 / Calendar & FUNdraisers</div>
            <h2
